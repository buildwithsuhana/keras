...
def main():
    ...
    try:
        ...
        for step in range(1, num_steps + 1):
            ...
            # Aggregate shards for all devices/ranks
            ...
            if all_max_diffs:
                ...
                max_diff = np.max(all_max_diffs)
                mean_diff = np.mean(all_mean_diffs)
                print(f"{header} Max Abs Diff = {max_diff:.2e}, Mean Abs Diff = {mean_diff:.2e}")
