...
FIXED VERSION V11: Complete fix for GPU assignment, imports, and distribution scope.

KEY FIXES:
1. GPU assignment BEFORE any torch.cuda calls or distributed init
2. Correct import path for torch_distribute_tensor
3. Proper distribution scope management
4. Synchronized initialization across all ranks
...
def run_opt_hybrid_dp_mp_test():
    ...
    print(f"\n{'='*70}")
    print(f"TEST: OPT MODEL WITH HYBRID DATA PARALLEL + MODEL PARALLEL (V11)")
    print(f"{'='*70}")
