...
class ShardedWeight:
    ...
    def __init__(self, tensor_shard, name, trainable=True, device_id=None):
        ...
        Args:
            ...
            name: The original hierarchical path (e.g., 'layer/kernel').
            trainable: Boolean indicating if the weight is trainable.
            device_id: Device identifier string for the variable placement.
        """
        dev_name = device_id or "unknown_device"

        # Keras Variable names cannot contain '/' or ':'. 
        # We transform the path into a 'flat_name' for backend compatibility.
