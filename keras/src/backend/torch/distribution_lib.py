...
def list_devices(device_type=None):
    ...
    if device_type in ("gpu", "cuda"):
        ...
        logger.warning("TPU device type is not supported by the default "
...
def get_device_count(device_type=None):
    ...
    Args:
        device_type: Optional device type to count (e.g., "cpu", "gpu", "cuda", "mps").
...
def distribute_data_input(per_process_batch, layout, batch_dim_name):
    ...
    Args:
        per_process_batch: `torch.Tensor` that is the local shard for this process.
