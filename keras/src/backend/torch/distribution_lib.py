...
def distribute_variable(value, layout):
    ...
    active_dist = distribution()
    if isinstance(active_dist, FSDP):
        # Bypass custom variable layouts for FSDP in Torch.
        # The trainer will wrap the model in FullyShardedDataParallel
        # which handles sharding internally.
        return value
