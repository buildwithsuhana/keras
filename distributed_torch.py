...
from shared_utils import get_data
from shared_utils import get_layout_map
from shared_utils import train_model
...
def run_torch(rank, world_size):
    ...
    dist = keras.distribution.ModelParallel(
        layout_map=get_layout_map(mesh), batch_dim_name="model"
    )
