#!/usr/bin/env python3
"""
OPT Model Load with Proper GPU Device Assignment

This script fixes the "Duplicate GPU detected" issue by properly
setting GPU device before any CUDA operations.
"""
...
print(f"\n{'='*70}")
print(f"TEST: OPT MODEL WITH PROPER GPU ASSIGNMENT")
print(f"{'='*70}")
...
if torch.cuda.is_available():
    ...
    # Map LOCAL_RANK to GPU device
    # Each process needs its own dedicated GPU
    ...
    # Verify the device is different for each rank
